...
Shader "BRDF/Standard"
{
	Properties
	{
		...
		_MaskRMetallicGRoughnessBAO(" Mask(R =Metallic, G = Roughness, B =AO)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_6_0_g2 = ( _BaseColor * tex2DNode16 ).rgb;
				float2 uv_MaskRMetallicGRoughnessBAO = IN.ase_texcoord8.xy * _MaskRMetallicGRoughnessBAO_ST.xy + _MaskRMetallicGRoughnessBAO_ST.zw;
				float4 tex2DNode17 = tex2D( _MaskRMetallicGRoughnessBAO, uv_MaskRMetallicGRoughnessBAO );
				float temp_output_8_0_g2 = tex2DNode17.r;
				float3 lerpResult11_g2 = lerp( temp_output_6_0_g2 , float3( 0,0,0 ) , temp_output_8_0_g2);
				float3 DiffuseColor1_g2 = lerpResult11_g2;
				float3 temp_cast_3 = (( _Specular * 0.08 )).xxx;
				float3 lerpResult12_g2 = lerp( temp_cast_3 , temp_output_6_0_g2 , temp_output_8_0_g2);
				float3 SpecularColor1_g2 = lerpResult12_g2;
				float clampResult125 = clamp( ( _Roughness * tex2DNode17.g ) , 0.001 , 1.0 );
				float temp_output_10_0_g2 = clampResult125;
				...
				float3 tangentToWorldDir16_g2 = normalize( mul( ase_tangentToWorldFast, UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f ) ) );
				float3 N1_g2 = tangentToWorldDir16_g2;
				...
				float3 N2_g2 = tangentToWorldDir16_g2;
				float3 V2_g2 = WorldViewDirection;
				float lerpResult158 = lerp( 1.0 , tex2DNode17.b , _AO);
				float Occlusion2_g2 = lerpResult158;
				float EnvRotation2_g2 = _EnvRotation;
				float3 IndirectLighting2_g2 = float3( 0,0,0 );
				IndirectLighting_float( DiffuseColor2_g2 , SpecularColor2_g2 , Roughness2_g2 , WorldPos2_g2 , N2_g2 , V2_g2 , Occlusion2_g2 , EnvRotation2_g2 , IndirectLighting2_g2 );
				
				float3 Albedo = temp_cast_0;
				float3 Normal = temp_cast_1;
				float3 Emission = ( DirectLighting1_g2 + IndirectLighting2_g2 );
				float3 Specular = 0.5;
				float Metallic = 0.0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode16 = tex2D( _BaseMap, uv_BaseMap );
				float3 temp_output_6_0_g2 = ( _BaseColor * tex2DNode16 ).rgb;
				float2 uv_MaskRMetallicGRoughnessBAO = IN.ase_texcoord4.xy * _MaskRMetallicGRoughnessBAO_ST.xy + _MaskRMetallicGRoughnessBAO_ST.zw;
				float4 tex2DNode17 = tex2D( _MaskRMetallicGRoughnessBAO, uv_MaskRMetallicGRoughnessBAO );
				float temp_output_8_0_g2 = tex2DNode17.r;
				float3 lerpResult11_g2 = lerp( temp_output_6_0_g2 , float3( 0,0,0 ) , temp_output_8_0_g2);
				float3 DiffuseColor1_g2 = lerpResult11_g2;
				float3 temp_cast_2 = (( _Specular * 0.08 )).xxx;
				float3 lerpResult12_g2 = lerp( temp_cast_2 , temp_output_6_0_g2 , temp_output_8_0_g2);
				float3 SpecularColor1_g2 = lerpResult12_g2;
				float clampResult125 = clamp( ( _Roughness * tex2DNode17.g ) , 0.001 , 1.0 );
				float temp_output_10_0_g2 = clampResult125;
				float Roughness1_g2 = temp_output_10_0_g2;
