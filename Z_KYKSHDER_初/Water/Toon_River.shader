...
Shader "Toon_River"
{
	Properties
	{
		...
		_FoamSpped("FoamSpped", Float) = 1
		_FoamFastSpped("FoamFastSpped", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 GlossyEnvReflection265( float3 R, float3 WorldPos, float Roughness )
			{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				#endif
				float3 vertexValue = ( WaveVertexPos194 * 0.01 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float3 PositionFormDepth5 = (mul( unity_CameraToWorld, appendResult49_g14 )).xyz;
				...
				float3 SurfaceNormal44 = BlendNormal( UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalMap, sampler_NormalMap, ( uv_NormalMap + temp_output_40_0 ) ), 1.0f ) , UnpackNormalScale( SAMPLE_TEXTURE2D( _NormalMap, sampler_NormalMap, ( ( uv_NormalMap * 2.0 ) + ( temp_output_40_0 * 0.5 ) ) ), 1.0f ) );
				float3 lerpResult217 = lerp( float3(0,0,1) , SurfaceNormal44 , _ReflectDistort);
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 worldRefl266 = reflect( -WorldViewDirection, float3( dot( tanToWorld0, lerpResult217 ), dot( tanToWorld1, lerpResult217 ), dot( tanToWorld2, lerpResult217 ) ) );
				float3 R265 = worldRefl266;
				float3 WorldPos265 = WorldPosition;
				float Roughness265 = ( 1.0 - 0.95 );
				float3 localGlossyEnvReflection265 = GlossyEnvReflection265( R265 , WorldPos265 , Roughness265 );
				...
				float3 ReflectColor65 = ( localGlossyEnvReflection265 * clampResult88 );
				...
				float temp_output_9_0_g13 = _FoamContrast;
				float2 uv_FoamNoise = IN.ase_texcoord8.xy * _FoamNoise_ST.xy + _FoamNoise_ST.zw;
				float2 panner222 = ( ( _FoamFastSpped * _TimeParameters.x ) * float2( 1,0 ) + uv_FoamNoise);
				float2 panner230 = ( ( _FoamSpped * _TimeParameters.x ) * float2( 1,0 ) + uv_FoamNoise);
				float lerpResult232 = lerp( SAMPLE_TEXTURE2D( _FoamNoise, sampler_FoamNoise, panner222 ).r , SAMPLE_TEXTURE2D( _FoamNoise, sampler_FoamNoise, panner230 ).r , IN.ase_color.r);
				float clampResult244 = clamp( exp( ( -WaterDepth9 / _FoamRange ) ) , 0.0 , 1.0 );
				float clampResult251 = clamp( ( clampResult244 * IN.ase_color.g ) , 0.0 , 1.0 );
				float clampResult8_g13 = clamp( ( ( lerpResult232 - 1.0 ) + ( clampResult251 * 2.0 ) ) , 0.0 , 1.0 );
				float lerpResult12_g13 = lerp( ( 0.0 - temp_output_9_0_g13 ) , ( temp_output_9_0_g13 + 1.0 ) , clampResult8_g13);
				float clampResult13_g13 = clamp( lerpResult12_g13 , 0.0 , 1.0 );
				float4 FoamColor179 = ( _FoamColor * clampResult13_g13 );
				float4 lerpResult185 = lerp( lerpResult81 , ( lerpResult81 + float4( (FoamColor179).rgb , 0.0 ) ) , (FoamColor179).a);
				
				float3 Albedo = _Vector1;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = max( lerpResult185 , float4( 0,0,0,0 ) ).rgb;
				float3 Specular = _Vector1;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNdotV22 = dot( normalizeWorldNormal, worldViewDir );
				float fresnelNode22 = ( 0.0 + 1.0 * pow( max( 1.0 - fresnelNdotV22 , 0.0001 ), _FresnelPower ) );
				float4 lerpResult20 = lerp( lerpResult13 , _FresnelColor , fresnelNode22);
				float4 WaterColor24 = lerpResult20;
				...
				float3 worldRefl266 = reflect( -worldViewDir, float3( dot( tanToWorld0, lerpResult217 ), dot( tanToWorld1, lerpResult217 ), dot( tanToWorld2, lerpResult217 ) ) );
				float3 R265 = worldRefl266;
				float3 WorldPos265 = WorldPosition;
				float Roughness265 = ( 1.0 - 0.95 );
				float3 localGlossyEnvReflection265 = GlossyEnvReflection265( R265 , WorldPos265 , Roughness265 );
				float fresnelNdotV85 = dot( normalizeWorldNormal, worldViewDir );
				float fresnelNode85 = ( 0.0 + _ReflectIntensity * pow( max( 1.0 - fresnelNdotV85 , 0.0001 ), _ReflectPower ) );
				float clampResult88 = clamp( fresnelNode85 , 0.0 , 1.0 );
				float3 ReflectColor65 = ( localGlossyEnvReflection265 * clampResult88 );
				float3 position188 = WorldPosition;
				...
				float4 lerpResult81 = lerp( ( WaterColor24 + float4( ReflectColor65 , 0.0 ) + WaveColor212 ) , UnderWaterColor78 , WaterOpacity27);
				float temp_output_9_0_g13 = _FoamContrast;
				float2 uv_FoamNoise = IN.ase_texcoord6.xy * _FoamNoise_ST.xy + _FoamNoise_ST.zw;
				float2 panner222 = ( ( _FoamFastSpped * _TimeParameters.x ) * float2( 1,0 ) + uv_FoamNoise);
				float2 panner230 = ( ( _FoamSpped * _TimeParameters.x ) * float2( 1,0 ) + uv_FoamNoise);
				float lerpResult232 = lerp( SAMPLE_TEXTURE2D( _FoamNoise, sampler_FoamNoise, panner222 ).r , SAMPLE_TEXTURE2D( _FoamNoise, sampler_FoamNoise, panner230 ).r , IN.ase_color.r);
				float clampResult244 = clamp( exp( ( -WaterDepth9 / _FoamRange ) ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18935
-2439;304;2395;975;-1274.826;-1140.071;1;True;True
...
Node;AmplifyShaderEditor.Vector4Node;190;483.2299,3414.602;Inherit;False;Property;_WaveASpeedXYSteepnesswavelength;WaveA(SpeedXY,Steepness,wavelength);22;0;Create;True;0;0;0;False;0;False;1,1,2,50;1,1,0,50;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;202;896.4585,3487.026;Inherit;False;Property;_WaveB;WaveB;23;0;Create;True;0;0;0;False;0;False;1,1,2,50;1,1,0,50;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;204;1315.266,3503.814;Inherit;False;Property;_WaveC;WaveC;24;0;Create;True;0;0;0;False;0;False;1,1,2,50;1,1,10.54,50;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CrossProductOpNode;197;1838.927,3584.207;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;191;1814.604,3104.836;Inherit;False;4;4;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalizeNode;198;2067.927,3619.207;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TransformDirectionNode;199;2290.927,3611.207;Inherit;False;World;Object;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;200;2573.927,3619.207;Inherit;False;WaveVertexNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;180;331.8936,4388.944;Inherit;False;2872.025;1540.065;Foam Color;26;179;181;182;232;220;233;231;230;222;223;221;228;224;225;227;226;240;242;243;244;246;247;249;251;252;239;Foam Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;30;-2081.971,2432.599;Inherit;False;2224.59;618.9851;ReflectColor;13;58;65;86;85;87;88;214;215;218;266;267;268;265;ReflectColor;0,0.006896734,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;53;-2080.094,1632.216;Inherit;False;2224.33;744.2101;Surface Normal;15;37;43;39;40;41;42;47;48;49;50;51;45;52;44;219;Surface Normal;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;271;2400.056,1557.25;Inherit;False;Constant;_Float4;Float 4;26;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;195;2343.192,1470.041;Inherit;False;194;WaveVertexPos;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;223;792.4185,4796.156;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SwizzleNode;7;-1101.581,342;Inherit;False;FLOAT;1;1;2;3;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;219;-1588.134,1721.279;Inherit;False;0;43;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;228;790.3583,5044.07;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1838.418,1311.052;Inherit;False;Property;_DeepRange;Deep Range;2;0;Create;True;0;0;0;False;0;False;1;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;43;-719.0941,1699.216;Inherit;True;Property;_NormalMap;NormalMap;5;0;Create;True;0;0;0;False;0;False;-1;None;972ba3323c209b54dacffe0942af5729;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;181;2484.172,5055.958;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.IndirectSpecularLight;214;-736.0676,2595.986;Inherit;False;Tangent;3;0;FLOAT3;0,0,1;False;1;FLOAT;0.5;False;2;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;2;-1960.581,349;Inherit;False;Reconstruct World Position From Depth;-1;;14;e7094bcbcc80eb140b2a3dbe6a861de8;0;0;1;FLOAT4;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;221;525.2581,4527.987;Inherit;False;0;220;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;244;1327.47,5517.016;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;98;-1873.77,4229.246;Inherit;False;Property;_CausticsSpeed;Caustics Speed;13;0;Create;True;0;0;0;False;0;False;-8,0;-8,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.LerpOp;217;-1198.865,2557.727;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;12;-2032.307,1161.268;Inherit;False;9;WaterDepth;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;224;523.2418,4768.936;Inherit;False;Property;_FoamFastSpped;FoamFastSpped;21;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;44;-104.7646,1908.48;Inherit;False;SurfaceNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;109;-1059.17,4576.391;Inherit;False;Property;_CausticsRange;Caustics Range;15;0;Create;True;0;0;0;False;0;False;1;0.6;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;239;609.0475,5454.984;Inherit;False;9;WaterDepth;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;100;-1018.77,3897.245;Inherit;True;Property;_CausticsTex;CausticsTex;11;0;Create;True;0;0;0;False;0;False;-1;None;4ab1d216348baa14ca2c92608a88695c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;86;-1555.307,2930.655;Inherit;False;Property;_ReflectPower;Reflect Power;8;0;Create;True;0;0;0;False;0;False;5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;240;849.4696,5511.016;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;227;529.2468,5165.048;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;264;2503.668,784.2151;Inherit;False;Constant;_Vector1;Vector 1;26;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ExpOpNode;243;1178.47,5530.016;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldReflectionVector;266;-992.4584,2535.378;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;269;-333.4584,2831.378;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleTimeNode;225;531.307,4917.134;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;39;-1637.094,2043.216;Inherit;False;Property;_NormalSpeed;NormalSpeed;6;0;Create;True;0;0;0;False;0;False;0,0;20,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;226;521.1816,5016.85;Inherit;False;Property;_FoamSpped;FoamSpped;20;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;215;-1112.865,2689.727;Inherit;False;Constant;_Float3;Float 3;33;0;Create;True;0;0;0;False;0;False;0.95;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;241;1021.47,5524.016;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FresnelNode;85;-1306.307,2819.655;Inherit;False;Standard;WorldNormal;ViewDir;True;True;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-2026.85,3525.49;Inherit;False;Property;_UnderWaterDistort;UnderWaterDistort;10;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;103;-693.1362,4231.033;Inherit;False;Property;_CausticsIntensity;Caustics Intensity;14;0;Create;True;0;0;0;False;0;False;3;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;106;-1246.17,4482.391;Inherit;False;9;WaterDepth;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;268;-839.4584,2736.378;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;58;-1579.17,2628.864;Inherit;False;44;SurfaceNormal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;72;-1589.85,3281.49;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;267;-1028.458,2720.378;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;252;1579.598,5588.234;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;253;2451.938,951.1508;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SwizzleNode;26;-419.057,1079.323;Inherit;False;FLOAT;3;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;28;-239.2765,1101.348;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;246;2107.762,5225.517;Inherit;False;HeightLerp;-1;;13;38f6a2bcb26e9c54881101b484fb3ca5;0;3;5;FLOAT;0;False;1;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;222;1066.636,4544.117;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-1073.026,1340.974;Inherit;False;Property;_FresnelPower;FresnelPower;4;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;265;-620.4584,2817.378;Inherit;False;return GlossyEnvironmentReflection(R,WorldPos,Roughness,1.0f)@;3;Create;3;True;R;FLOAT3;0,0,0;In;;Inherit;False;True;WorldPos;FLOAT3;0,0,0;In;;Inherit;False;True;Roughness;FLOAT;0;In;;Inherit;False;GlossyEnvReflection;True;False;0;;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;78;-794.85,3356.49;Inherit;False;UnderWaterColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ScreenColorNode;70;-1427.597,3279.354;Inherit;False;Global;_GrabScreen0;Grab Screen 0;10;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;247;1740.736,5675.882;Inherit;False;Property;_FoamContrast;FoamContrast;19;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;232;1736.856,4925.493;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;88;-1016.02,2855.663;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;231;1330.115,4913.663;Inherit;True;Property;_FoamNiuse;FoamNiuse;17;0;Create;True;0;0;0;False;0;False;-1;None;31e68d75d2651c148b4a9a296306d21c;True;0;False;white;Auto;False;Instance;220;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMaxOpNode;145;2506.389,1095.178;Inherit;False;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;21;-1043.026,1088.974;Inherit;False;Property;_FresnelColor;FresnelColor;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.1803916,0.2431366,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;218;-1596.865,2718.727;Inherit;False;Property;_ReflectDistort;Reflect Distort;9;0;Create;True;0;0;0;False;0;False;0;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;10;-1473.305,685.7887;Inherit;False;Property;_DeepColor;DeepColor;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.06274458,0.3803914,0.3568621,0.508;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;249;1022.432,5721.514;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;25;895.3306,853.7051;Inherit;False;24;WaterColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;179;2622.066,5052.386;Inherit;False;FoamColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;251;1749.432,5326.514;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;65;-267.1708,2591.864;Inherit;False;ReflectColor;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;92;-1761.77,4013.245;Inherit;False;Property;_CausticsScale;Caustics Scale;12;0;Create;True;0;0;0;False;0;False;8;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;20;-601.208,936.8713;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;182;2230.203,4944.715;Inherit;False;Property;_FoamColor;FoamColor;16;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;211;2354.689,3426.79;Inherit;False;Property;_WaveColor;WaveColor;25;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;233;1423.856,5182.493;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-1497.365,925.9494;Inherit;False;Property;_ShallowColor;ShallowColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2901954,0.9529411,0.7803922,0.4588235;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PannerNode;230;1109.346,4940.008;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SwizzleNode;184;1651.309,1375.099;Inherit;False;FLOAT;3;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;27;-58.27649,1087.348;Inherit;False;WaterOpacity;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;220;1370.267,4503.542;Inherit;True;Property;_FoamNoise;FoamNoise;17;0;Create;True;0;0;0;False;0;False;-1;None;31e68d75d2651c148b4a9a296306d21c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;213;841.3707,1022.3;Inherit;False;212;WaveColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;119;-1228.364,3301.722;Inherit;False;SceneColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;118;-1216.364,3455.722;Inherit;False;101;CausticsColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;1382.309,1371.099;Inherit;False;179;FoamColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;242;765.4696,5628.016;Inherit;False;Property;_FoamRange;FoamRange;18;0;Create;True;0;0;0;False;0;False;1;0.29;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-1543.307,2848.655;Inherit;False;Property;_ReflectIntensity;Reflect Intensity;7;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
WireConnection;246;5;251;0
WireConnection;246;1;232;0
WireConnection;246;9;247;0
...
WireConnection;232;0;220;1
WireConnection;232;1;231;1
WireConnection;232;2;233;1
...
WireConnection;270;0;195;0
WireConnection;270;1;271;0
WireConnection;255;0;264;0
WireConnection;255;2;145;0
WireConnection;255;9;264;0
WireConnection;255;6;253;4
WireConnection;255;8;270;0
WireConnection;255;10;201;0
ASEEND*/
//CHKSM=B26FCDAE88602B020E144E96CB22698AE30E56B2