...
Shader "CityBuild_GlassRef"
{
	Properties
	{
		...
		_Normal("Normal", Range( 0 , 30)) = 1
		_MetallicMap("MetallicMap", 2D) = "white" {}
		_Metallic("Metallic", Range( 0 , 1)) = 0.5
		_SmoothnessMap("SmoothnessMap", 2D) = "white" {}
		_SmoothnessAdd("SmoothnessAdd", Range( 0 , 1)) = 0
		_Smoothness1("Smoothness1", Range( 0 , 1)) = 0
		_AOMap("AOMap", 2D) = "white" {}
		_AO("AO", Range( 0 , 1)) = 0.5
		_CubeMap("CubeMap", CUBE) = "white" {}
		[HDR]_CubeColor("CubeColor", Color) = (1,1,1,0)
		_CubeNormalMap("CubeNormalMap", 2D) = "bump" {}
		_CubeNormal("CubeNormal", Float) = 1
		_CubeMask("CubeMask", 2D) = "white" {}
		[ASEEnd]_Mip("Mip", Range( 0 , 10)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _Normal );
				unpack13.z = lerp( 1, unpack13.z, saturate(_Normal) );
				
				float2 uv_CubeNormalMap = IN.ase_texcoord8.xyz.xy * _CubeNormalMap_ST.xy + _CubeNormalMap_ST.zw;
				float3 unpack53 = UnpackNormalScale( tex2D( _CubeNormalMap, uv_CubeNormalMap ), _CubeNormal );
				unpack53.z = lerp( 1, unpack53.z, saturate(_CubeNormal) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 worldRefl21 = reflect( -WorldViewDirection, float3( dot( tanToWorld0, unpack53 ), dot( tanToWorld1, unpack53 ), dot( tanToWorld2, unpack53 ) ) );
				float2 uv_CubeMask = IN.ase_texcoord8.xyz.xy * _CubeMask_ST.xy + _CubeMask_ST.zw;
				
				float2 uv_MetallicMap = IN.ase_texcoord8.xyz.xy * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
				
				float2 uv_SmoothnessMap = IN.ase_texcoord8.xyz.xy * _SmoothnessMap_ST.xy + _SmoothnessMap_ST.zw;
				
				float2 uv_AOMap = IN.ase_texcoord8.xyz.xy * _AOMap_ST.xy + _AOMap_ST.zw;
				float lerpResult17 = lerp( 1.0 , tex2D( _AOMap, uv_AOMap ).r , _AO);
				
				float3 Albedo = tex2D( _MainTex, uv_MainTex ).rgb;
				float3 Normal = unpack13;
				float3 Emission = ( ( texCUBElod( _CubeMap, float4( worldRefl21, _Mip) ) * _CubeColor ) * tex2D( _CubeMask, uv_CubeMask ).r ).rgb;
				float3 Specular = 0.5;
				float Metallic = ( _Metallic * tex2D( _MetallicMap, uv_MetallicMap ).r );
				float Smoothness = ( saturate( ( ( tex2D( _SmoothnessMap, uv_SmoothnessMap ).r * 0.0 ) + _SmoothnessAdd ) ) * _Smoothness1 );
				float Occlusion = lerpResult17;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_CubeNormalMap = IN.ase_texcoord4.xyz.xy * _CubeNormalMap_ST.xy + _CubeNormalMap_ST.zw;
				float3 unpack53 = UnpackNormalScale( tex2D( _CubeNormalMap, uv_CubeNormalMap ), _CubeNormal );
				unpack53.z = lerp( 1, unpack53.z, saturate(_CubeNormal) );
				...
				float3 worldRefl21 = reflect( -ase_worldViewDir, float3( dot( tanToWorld0, unpack53 ), dot( tanToWorld1, unpack53 ), dot( tanToWorld2, unpack53 ) ) );
				float2 uv_CubeMask = IN.ase_texcoord4.xyz.xy * _CubeMask_ST.xy + _CubeMask_ST.zw;
...
/*ASEBEGIN
Version=18935
127;470;619;270;1958.201;-462.9417;2.790971;True;False
Node;AmplifyShaderEditor.RangedFloatNode;22;-385.894,768.8953;Inherit;False;Property;_Mip;Mip;15;0;Create;True;0;0;0;False;0;False;1;7.92;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-942.5666,668.4108;Inherit;False;Property;_CubeNormal;CubeNormal;13;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;575.7497,406.574;Inherit;True;Property;_NormalMap;NormalMap;1;0;Create;True;0;0;0;False;0;False;-1;None;1c54b705222b57149b5721e2de494715;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;38;519.0482,728.4686;Inherit;True;Property;_CubeMask;CubeMask;14;0;Create;True;0;0;0;False;0;False;-1;None;25475268abb5f404f8f93236180ef431;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;53;-695.6291,619.5497;Inherit;True;Property;_CubeNormalMap;CubeNormalMap;12;0;Create;True;0;0;0;False;0;False;-1;None;ad5e672ab95edcf4fba892927d0b8a7c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldReflectionVector;21;-301.457,622.914;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SamplerNode;10;283.353,217.7158;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;4437d715e18ba8f4f80f47b3860288be;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;15;277.5837,689.2288;Inherit;False;Property;_CubeColor;CubeColor;11;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0.6431373,0.6431373,2.996078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;450.6384,939.3112;Inherit;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;0;False;0;False;0.5;0.461;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;57;-106.4407,475.6099;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;752.9462,943.9879;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;1006.467,734.1098;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;23;211.8756,462.9863;Inherit;False;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;1;1;0;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;409.0856,1443.485;Inherit;False;Constant;_Float0;Float 0;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;14;-11.70697,620.8256;Inherit;True;Property;_CubeMap;CubeMap;10;0;Create;True;0;0;0;False;0;False;-1;None;b509c10eeb5c70748bd904da33328b4e;True;0;False;white;LockedToCube;False;Object;-1;MipLevel;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;20;412.0938,1534.839;Inherit;False;Property;_AO;AO;9;0;Create;True;0;0;0;False;0;False;0.5;0.69;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;108.4933,1177.316;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;548.6264,627.1498;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;19;128.8735,1443.265;Inherit;True;Property;_AOMap;AOMap;8;0;Create;True;0;0;0;False;0;False;-1;None;1490bc9b5c9d9fd49a3ab33581d3f58c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;48;509.5828,1177.008;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;56;-288.7628,429.6067;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp;17;774.0511,1443.862;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;24;162.6626,941.0403;Inherit;True;Property;_MetallicMap;MetallicMap;3;0;Create;True;0;0;0;False;0;False;-1;None;ab0378f3d0c8f37478ad553ccd70c582;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;50;424.6945,1273.067;Inherit;False;Property;_Smoothness1;Smoothness1;7;0;Create;True;0;0;0;False;0;False;0;0.526;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;47;-26.72854,1278.822;Inherit;False;Property;_SmoothnessAdd;SmoothnessAdd;6;0;Create;True;0;0;0;False;0;False;0;0.771;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;46;302.5902,1176.032;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;777.6937,1218.058;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;26;-327.6359,1145.968;Inherit;True;Property;_SmoothnessMap;SmoothnessMap;5;0;Create;True;0;0;0;False;0;False;-1;None;d2ad7c36a43527c46b528886c50e073a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=BF4E70EF75524025F0EEA25958490BF3E7226411